...
<!DOCTYPE html>
<!-- saved from url=(0074)file:///C:/Users/82103/DOCUME~1/%EC%B9%B4%EC%B9%B4%EC%98%A4~1/SIGNFO~2.HTM -->
<html lang="ko">
<head>
...
<body>
	<div class="container">
		...
		<div class="row">
			<p></p>
			<div class="col-md-12">
				<small> <strong><a href="login.do">로그인</a> | <a
						href="join.do">회원가입</a></strong>
				</small>
			</div>
		</div>
		<!--// 헤더 들어가는 부분 -->
...
[개인정보 보호법] 제21조에 따라 처리합니다. 
					...
					<div class="radio">
						<label> <input type="radio" id="memberInfoYn"
							name="userPolicy" value="Y" checked /> 동의합니다.
						</label>
					</div>
					<div class="radio">
						<label> <input type="radio" id="memberInfoYn"
							name="userPolicy" value="N" /> 동의하지 않습니다.
						</label>
					</div>
				</div>
			</div>
			...
			<div class="form-group" id="divDate">
				<label for="inputDate" class="col-lg-2 control-label">생년월일</label>
				<div class="col-lg-10">
        ...
        <div>
            <p class="text-center">
                <small><strong>Jo Melone</strong></small><br>
                <small> ㆍ주소 : 서울특별시 중구 남대문로 120 대일빌딩 2층, 3층 ㆍ 사업자등록번호:564-88-00313 ㆍ 전화 : 02-1544-9970</small><br>
                <small>Copyrightⓒ Jo Melone ALL RIGHTS RESERVED.</small>
            </p>
        </div>
        <!--// 푸터 들어가는 부분 -->
    </div>
